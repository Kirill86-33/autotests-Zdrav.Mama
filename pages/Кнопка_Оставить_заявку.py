...
class LeavePage(BasePage):
    ...
    BUTTON_LEAVE = ("xpath", "//a//h5[@class='MuiTypography-root MuiTypography-h5 css-1ycxley']")
    ...
    def click_send_leave(self):
        button_leave = self.driver.find_element(*self.BUTTON_LEAVE)
