...
class ButtonUniquePage(BasePage):
    PAGE_URL = 'https://mama.zdrav.mosreg.ru/'


    BUTTON_UNIQUE_OFFER = ("xpath", "//div//h5[text()='Получить уникальное предложение']")
    ...
    def click_unique_offer(self):
        button_unique = self.driver.find_element(*self.BUTTON_UNIQUE_OFFER)
        self.driver.execute_script("arguments[0].click();", button_unique)
